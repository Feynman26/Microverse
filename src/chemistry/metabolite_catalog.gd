...
# C/N/P bookkeeping and ligand identity are independent. Ligand signatures do
# not encode semantic meaning; they only provide a generic molecular binding
# target for M5-B allostery.
